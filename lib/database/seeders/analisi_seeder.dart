  ...
  List<Analisi> get seeds => [
        ...
        Analisi(
          ...
          test: [
            ...
            Tuple2("Perché il riuso del software è vantaggioso e quali criticità può presentare?",
            ...
            Tuple2("Qual è la differenza tra usabilità e user experience in un software?",
        ...
        Analisi(
            ...
            test: [
              Tuple2("Cos’è la “curva di taratura” e perché non è perfettamente lineare?",
              ...
              Tuple2("Cos’è uno Smart Sensor e quali vantaggi offre?",
            ...
            chat: [
              Tuple2(
                "Ciao, sono stata assente alla lezione, potresti dirmi i principali argomenti che ha spiegato?",
                """Certo! È un peccato tu non abbia potuto seguire la lezione: è stata ricca di spunti importanti. I contenuti principali si possono suddividere in due aree:
Caratteristiche dei sensori:
-	Curva di taratura
-	Non linearità, isteresi, dead band
-	Effetti dei fattori ambientali e concetto di rangeability
...
-	Amplificazione e filtraggio del segnale""",
              ...
              Tuple2(
                "Grazie, ho visto le slides, ma di condizionamento dei segnali ha spiegato tutto nel dettaglio?",
                """Non del tutto, e non è un problema! Il docente ha chiarito che si trattava di una panoramica introduttiva.
L’obiettivo era far comprendere il **ruolo del condizionamento del segnale** all’interno del flusso di acquisizione dati: dove si colloca la strumentazione, cosa fa e perché è necessaria.
In particolare, ha voluto trasmettere un’intuizione generale su impedance matching e amplificazione, senza entrare nei dettagli di progettazione.
In pratica: "*quando connetti un sensore, è importante sapere cosa succede al segnale e perché serve un'interfaccia a monte del sistema digitale.*""",
              ),
              Tuple2(
                "Ha suggerito qualche approfondimento?",
                """Sì! Ha consigliato un testo molto utile: “**Handbook of Modern Sciences**”, disponibile in biblioteca.
È una raccolta di schede tecniche e approfondimenti su diverse famiglie di sensori, con dettagli su:
-	i principi fisici di funzionamento
-	le tecnologie costruttive
-	i circuiti di condizionamento associati
È particolarmente indicato per chi vuole esplorare casi reali o lavorare su progetti pratici.
""",
              )
            ]),
        Analisi(
          ...
          test: [
            ...
            Tuple2("Che vantaggio offre la trasparenza referenziale nella programmazione funzionale?",
        ...
        Analisi(
          ...
          test: [
            Tuple2("Qual è il ruolo di Node.js nello sviluppo web e perché è utile lato server?",
            ...
            Tuple2("Perché JSON è preferito all’XML nelle moderne applicazioni web?",
            ...
            Tuple2("Qual è la differenza tra var, let e const in JavaScript?",
          ...
          topics: ["Node.js", "JSON vs XML", "Scope variabili", "Tipizzazione in Python e JavaScript"],
        ),
      ];
}
